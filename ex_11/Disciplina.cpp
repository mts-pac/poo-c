...
Disciplina::~Disciplina() {
  ...
  std::list<Pessoa*>::iterator end{this->alunos.end()};
  std::list<Pessoa*>::iterator it2;
...
const std::list<Pessoa*>::iterator Disciplina::removerAluno(
    const std::list<Pessoa*>::iterator it) {
